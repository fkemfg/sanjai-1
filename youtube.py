...
def Api_connect():
    Api_Id="AIzaSyDDeqcf8CD6U_Vx62MbAaMSHh0UC5zC99w"
...
def videos_table():
    ...
    create_query = '''create table if not exists videos(Channel_Name varchar(150),
                            Channel_Id varchar(100),
                            Video_Ids varchar(50) primary key, 
                            Title varchar(150), 
                            Tags text,
                            Thumbnails varchar(225),
                            Description text, 
...
if question=="1. All the videos and the channel name":
    ...
    query6='''select likes as likecount,title as videotitlef from videos'''
